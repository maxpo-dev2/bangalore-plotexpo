...
const EVENT_DATE = process.env.EVENT_DATE || "June 27-28, 2026";
const EVENT_WEBSITE = process.env.EVENT_WEBSITE || "https://plotexpo.in/";
    ...
    <tr>
      <td align="center">
        <table width="600" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding:40px 30px;text-align:center;">
              ...
              <p>
                ...
                <strong style="color:#00214d;">${EVENT_NAME}</strong> 
                on <strong style="color:#fdb714;">${EVENT_DATE}</strong> 
                at <strong style="color:#017B17;">${EVENT_VENUE}</strong>.
              </p>
              ...
              <div style="background:#fff6e0;padding:20px;border-left:4px solid #fdb714;margin:30px 0;">
                <p style="margin:0;font-size:24px;font-weight:bold;color:#00214d;">
                  ${visitorPassId}
                </p>
              </div>
              ...
              <p style="margin-top:20px;font-size:14px;color:#555;">
                <strong>Note:</strong> For this edition of the event, the QR code above is only used for testing purposes. 
                Visitors are not required to carry this QR code. 
                Please visit the registration counter at the venue and share your <strong>name</strong> with our team 
                to receive your <strong>free visitor pass</strong>.
              </p>
              ...
              <table style="margin:20px auto;">
                <tr>
                  ...
                  <td style="padding:0 8px;">
                    <a href="https://www.facebook.com/bengalurusplotexpo/" target="_blank"
                      style="display:inline-block;width:50px;height:50px;background:#e6e9ef;border-radius:50%;text-align:center;line-height:50px;text-decoration:none;">
                      <img src="https://cdn-icons-png.flaticon.com/512/733/733547.png" alt="Facebook" width="24" height="24" style="vertical-align:middle;" />
                    </a>
                  </td>

                  <td style="padding:0 8px;">
                    <a href="https://www.youtube.com/@BengaluruPlotExpo" target="_blank"
                      style="display:inline-block;width:50px;height:50px;background:#e6e9ef;border-radius:50%;text-align:center;line-height:50px;text-decoration:none;">
                  ...
                  <td style="padding:0 8px;">
                    <a href="https://www.linkedin.com/showcase/bengaluru-plot-expo/" target="_blank"
                      style="display:inline-block;width:50px;height:50px;background:#e6e9ef;border-radius:50%;text-align:center;line-height:50px;text-decoration:none;">
                  ...
                  <td style="padding:0 8px;">
                    <a href="https://www.instagram.com/bengaluru_plotexpo/" target="_blank"
                      style="display:inline-block;width:50px;height:50px;background:#e6e9ef;border-radius:50%;text-align:center;line-height:50px;text-decoration:none;">
          ...
          <tr>
            <td style="background:#f5f5f5;padding:30px;text-align:center;border-top:1px solid #ddd;">
              <p style="font-weight:600;">Best Regards,</p>
              <p style="font-weight:700;color:#00214d;">${EVENT_NAME}</p>
              <p>
                <a href="${EVENT_WEBSITE}" style="color:#fdb714;">${EVENT_WEBSITE}</a>
              </p>
              <p>
                Contact: 
                <a href="mailto:${EVENT_EMAIL}" style="color:#00214d;">
                  ${EVENT_EMAIL}
                </a>
              </p>
            </td>
